...
public class CountriesMenu extends JFrame {
    public CountriesMenu() {
        ...
        comboBox.addActionListener(e -> {
            ...
            switch (item){
                case "Россия":
                    populationLabel.setText("Население: 146.1 million");
                    break;
                case "США":
                    populationLabel.setText("Население: 301.7 million");
                    break;
                case "Китай":
                    populationLabel.setText("Население: 1,410.5 million");
            }
        });
        comboBox.setSelectedItem("Россия");
    }
